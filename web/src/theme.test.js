...
test("light terminal palette preserves ANSI black and brightens ANSI bright black", () => {
  assert.equal(TERMINAL_THEME_LIGHT.black, "#0f172a");
  assert.equal(TERMINAL_THEME_LIGHT.brightBlack, "#d0dae6");
});
